...
export const mockMetrics = [
  { label: 'Stress', value: '--', unit: '', icon: 'flash-outline' as const, color: '#C9963A' },
  { label: 'Recovery', value: '--', unit: '', icon: 'fitness-outline' as const, color: '#C9963A' },
  ...
  { label: 'Coher.', value: '--', unit: '', icon: 'water-outline' as const, color: '#C9963A' },
];
...
export const mockPricingTiers = [
  {
    ...
    features: [
      ...
      'All faith, prayer & Scripture features',
      '1 training session per day (breathing)',
      'Mood & food logging',
  ...
  },
  {
    ...
    features: [
      ...
      'Live BLE device connection',
      '22-metric HRV analysis',
      'Unlimited AI coach',
      'Unlimited training sessions',
      'Auto HRV snapshot tracking',
      'Full insights & sleep analysis',
